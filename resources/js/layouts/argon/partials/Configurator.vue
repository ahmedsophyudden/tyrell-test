  ...
  <div class="fixed-plugin">
    ...
    <div class="shadow-lg card">
      <div class="pt-3 pb-0 bg-transparent card-header">
        <div
          class=""
          :class="layoutStore.isRTL ? 'float-end' : 'float-start'"
        >
        ...
        <div
          class="mt-4"
          @click="toggle"
          :class="layoutStore.isRTL ? 'float-start' : 'float-end'"
        >
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <a href="#" class="switch-trigger background-color">
          <div
            ...
            :class="layoutStore.isRTL ? 'text-end' : ' text-start'"
          >
            <span
        ...
        <div class="d-flex gap-2">
          <button
            ...
            :class="
              layoutStore.sidebarType === 'bg-white'
                ? 'bg-gradient-success'
                : 'btn-outline-success'
            "
          ...
          <button
            ...
            class="btn w-100 px-3 mb-2"
            :class="
              layoutStore.sidebarType === 'bg-default'
                ? 'bg-gradient-success'
                : 'btn-outline-success'
            "
        ...
        <div class="mt-3 d-flex">
          ...
          <div class="form-check form-switch ps-0 ms-auto my-auto">
            <input
              ...
              :class="
                layoutStore.isRTL ? 'float-end  me-auto' : ' ms-auto'
              "
              type="checkbox"
              id="navbarFixed"
              :checked="layoutStore.isNavFixed"
        ...
        <div class="mt-2 mb-5 d-flex">
          <h6 class="mb-0" :class="layoutStore.isRTL ? 'ms-2' : ''">
            Light / Dark
          </h6>
          <div class="form-check form-switch ps-0 ms-auto my-auto">
            <input
...
import { activateDarkMode, deactivateDarkMode } from "@argon/assets/js/dark-mode";
...
function sidebarColor(color = "success") {
  ...
  layoutStore.mcolor = `card-background-mask-${color}`;
}
function sidebarType(type) {
  layoutStore.sidebarType = type;
}

function setNavbarFixed() {
  // if (this.$route.name !== "Profile" || this.$route.name !== "All Projects") {
  //   layoutStore.isNavFixed = !layoutStore.isNavFixed;
  // }
}

function setDarkMode() {
  if (layoutStore.darkMode) {
    layoutStore.darkMode = false;
    layoutStore.sidebarType = "bg-white";
    deactivateDarkMode();
    return;
  } else {
    layoutStore.darkMode = true;
    layoutStore.sidebarType = "bg-default";
    activateDarkMode();
  }
}
...
const sidenavResponsive = computed(() => {
  return sidenavTypeOnResize;
});
