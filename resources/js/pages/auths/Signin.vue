                  ...
                  <form role="form">
                    ...
                    <div class="mb-3">
                      <argon-input
                        ...
                        name="password"
                        v-model="authStore.data.password"
                        size="lg"
                      />
                    </div>
...
<script setup>
import Navbar from "@/layouts/argon/partials/PageLayout/Navbar.vue";
import ArgonAlert from "@argon/components/ArgonAlert.vue";
import ArgonInput from "@argon/components/ArgonInput.vue";
import ArgonSwitch from "@argon/components/ArgonSwitch.vue";
...
async function signIn() {
  const { res, error } = await authStore.signIn();
  if (res.value) {
